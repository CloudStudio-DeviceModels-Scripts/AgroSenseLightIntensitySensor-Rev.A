...
# Parsing + Configuration Script – AgroSense Light Intensity Sensor - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense Light Intensity Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense Light Intensity Sensor Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense Light Intensity Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
